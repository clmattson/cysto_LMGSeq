...
#dont think the above line does what Sam wants it to. courtney edits:
...
do
  ...
  for file in trimmed_${cross}_sample*_*_R1.fastq;
  do
...
for file1 in cross*_
*_*_merged.fastq.assembled.fastq;
do
